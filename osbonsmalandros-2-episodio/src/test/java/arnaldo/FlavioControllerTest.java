...
public class FlavioControllerTest {
	...
	public void testOla() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/ola")).andDo(print());
		this.mockMvc.perform(MockMvcRequestBuilders.get("/ola")).andExpect(forwardedUrl("osbonsmalandros"));
